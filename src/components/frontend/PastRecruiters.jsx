...
const PastRecruiters = () => {
  ...
  return (
    <div
      className="p-6 min-h-screen flex flex-col items-center bg-gray-100"
      style={{
        backgroundImage: "url('https://arrelic.com/frontend/media/map-bg.png')",
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
    >
      <h2 className="text-3xl font-bold mb-8">Past Recruiters</h2>
      <div className="grid grid-cols-3 gap-0 w-full max-w-md ">
        {logos.slice(0, 6).map((logo, index) => (
          <div
            key={index}
            className="relative overflow-hidden w-full h-38 border border-gray-300"
          >
            <img
              src={logo}
              alt={`Logo ${index + 1}`}
